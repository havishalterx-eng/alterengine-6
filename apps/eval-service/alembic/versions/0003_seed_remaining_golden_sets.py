"""Seed the remaining five version-1 hardening launch-floor golden sets."""
...
def upgrade() -> None:
    ...
    for golden_set in REMAINING_GOLDEN_SETS:
        op.execute(
            _ddl(
...
def downgrade() -> None:
    ...
    golden_set_ids = [golden_set.id for golden_set in REMAINING_GOLDEN_SETS]
