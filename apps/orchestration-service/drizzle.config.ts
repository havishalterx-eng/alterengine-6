...
const url = process.env.ORCHESTRATION_DATABASE_URL;

if (!url) {
  throw new Error(
    "ORCHESTRATION_DATABASE_URL is required, e.g. postgresql://orchestration_service:<password>@localhost:5433/orchestration_db",
  );
}
