...
Global search across workflows, runs and agents.
...
- `apps/platform-web/src/features`
- `apps/platform-api/src/discovery`

## Current state

*Verbatim from the readiness assessment — engine verified against main 4–6 September 2026; platform reported as received and not independently verified.*

**Global search returns invented results** — the one item in this category that is actively misleading rather than merely inert.
...
§5.5 fail-closed makes this one urgent rather than cosmetic: a surface that reports success or invents results is worse than one that visibly does nothing.
